...
FIELDS = {
    ...
    'ACC_4': ('sequence', DATATYPES_STRUCTS['CE'], 'CE', 'AUTO_ACCIDENT_STATE', None, -1),
    ...
    'AIL_4': ('sequence', DATATYPES_STRUCTS['CE'], 'CE', 'LOCATION_TYPE', None, -1),
    ...
    'APR_1': ('sequence', DATATYPES_STRUCTS['SCV'], 'SCV', 'TIME_SELECTION_CRITERIA', None, -1),
    'APR_2': ('sequence', DATATYPES_STRUCTS['SCV'], 'SCV', 'RESOURCE_SELECTION_CRITERIA', None, -1),
    'APR_3': ('sequence', DATATYPES_STRUCTS['SCV'], 'SCV', 'LOCATION_SELECTION_CRITERIA', None, -1),
    ...
    'ARQ_12': ('leaf', None, 'ST', 'PRIORITY', None, -1),
    ...
    'AUT_1': ('sequence', DATATYPES_STRUCTS['CE'], 'CE', 'AUTHORIZING_PAYOR_PLAN_CODE', 'HL70072', -1),
    ...
    'BLG_3': ('sequence', DATATYPES_STRUCTS['CK'], 'CK', 'ACCOUNT_ID', None, -1),
    ...
    'CDM_1': ('sequence', DATATYPES_STRUCTS['CE'], 'CE', 'PRIMARY_KEY_VALUE', 'HL70132', -1),
    ...
    'CDM_5': ('leaf', None, 'ID', 'DESCRIPTION_OVERRIDE_INDICATOR', 'HL70268', -1),
    'CDM_6': ('sequence', DATATYPES_STRUCTS['CE'], 'CE', 'EXPLODING_CHARGES', None, -1),
    'CDM_7': ('sequence', DATATYPES_STRUCTS['CE'], 'CE', 'PROCEDURE_CODE', None, -1),
    ...
    'CM0_1': ('leaf', None, 'SI', 'CM0_SET_ID', None, -1),
    'CM0_2': ('sequence', DATATYPES_STRUCTS['EI'], 'EI', 'SPONSOR_STUDY_ID', None, -1),
    'CM0_3': ('sequence', DATATYPES_STRUCTS['CE'], 'CE', 'ALTERNATE_STUDY_ID', None, -1),
    ...
    'CSR_5': ('sequence', DATATYPES_STRUCTS['CX'], 'CX', 'ALTERNATE_PATIENT_ID', None, -1),
    ...
    'CSR_12': ('sequence', DATATYPES_STRUCTS['CE'], 'CE', 'STUDY_RANDOMIZED_ARM', None, -1),
    ...
    'CTD_7': ('sequence', DATATYPES_STRUCTS['CM_PI'], 'CM_PI', 'CONTACT_IDENTIFIERS', None, -1),
    ...
    'DB1_2': ('leaf', None, 'IS', 'DISABLED_PERSON_CODE', 'HL70033', -1),
    ...
    'DG1_3': ('sequence', DATATYPES_STRUCTS['CE'], 'CE', 'DIAGNOSIS_CODE', 'HL70051', -1),
    ...
    'DG1_15': ('leaf', None, 'NM', 'DIAGNOSIS_PRIORITY', None, -1),
    ...
    'EVN_5': ('sequence', DATATYPES_STRUCTS['CN'], 'CN', 'OPERATOR_ID', 'HL70188', -1),
    'EVN_6': ('sequence', DATATYPES_STRUCTS['TS'], 'TS', 'EVENT_OCCURED', None, -1),
    'FAC_1': ('sequence', DATATYPES_STRUCTS['EI'], 'EI', 'FACILITY_ID', None, -1),
    ...
    'GOL_8': ('sequence', DATATYPES_STRUCTS['TS'], 'TS', 'EXPECTED_GOAL_ACHIEVEMENT_DATE_TIME', None, -1),
    ...
    'GT1_11': ('leaf', None, 'IS', 'GUARANTOR_RELATIONSHIP', 'HL70063', -1),
    ...
    'GT1_18': ('sequence', DATATYPES_STRUCTS['XTN'], 'XTN', 'GUARANTOR_EMPLOY_PHONE_NUMBER', None, -1),
    ...
    'GT1_21': ('sequence', DATATYPES_STRUCTS['XON'], 'XON', 'GUARANTOR_ORGANIZATION', None, -1),
    'GT1_22': ('leaf', None, 'ID', 'GUARANTOR_BILLING_HOLD_FLAG', 'HL70136', -1),
    'GT1_23': ('sequence', DATATYPES_STRUCTS['CE'], 'CE', 'GUARANTOR_CREDIT_RATING_CODE', None, -1),
    ...
    'GT1_30': ('leaf', None, 'IS', 'GUARANTOR_MARITAL_STATUS_CODE', None, -1),
    ...
    'GT1_48': ('leaf', None, 'IS', 'CONTACT_RELATIONSHIP_CODE', 'HL70063', -1),
    ...
    'IN1_6': ('sequence', DATATYPES_STRUCTS['XPN'], 'XPN', 'INSURANCE_CO_CONTACT_PPERS', None, -1),
    ...
    'IN1_10': ('sequence', DATATYPES_STRUCTS['CX'], 'CX', 'INSURED_S_GROUP_EMPLOYER_ID', None, -1),
    ...
    'IN1_17': ('leaf', None, 'IS', 'INSURED_S_RELATIONSHIP_TO_PATIENT', 'HL70063', -1),
    ...
    'IN1_25': ('leaf', None, 'ID', 'RPT_OF_EIGIBILITY_CODE', 'HL70136', -1),
    'IN1_26': ('leaf', None, 'DT', 'RPT_OF_ELIGIBILITY_DATE', None, -1),
    ...
    'IN1_30': ('sequence', DATATYPES_STRUCTS['XPN'], 'XPN', 'VERIFICATION_BY', None, -1),
    ...
    'IN1_44': ('sequence', DATATYPES_STRUCTS['XAD'], 'XAD', 'INSURED_S_EMPLOYER_ADDRESS', None, -1),
    ...
    'IN1_48': ('leaf', None, 'IS', 'HANDICAP', 'HL70310', -1),
    ...
    'IN2_3': ('sequence', DATATYPES_STRUCTS['XCN'], 'XCN', 'INSURED_S_EMPLOYER_NAME', None, -1),
    ...
    'IN2_9': ('sequence', DATATYPES_STRUCTS['XPN'], 'XPN', 'CHAMPUS_SPONSOR_NAME', None, -1),
    'IN2_10': ('leaf', None, 'ST', 'CHAMPUS_ID_NUMBER', None, -1),
    'IN2_11': ('sequence', DATATYPES_STRUCTS['CE'], 'CE', 'DEPENDENT_OF_CHAMPUS_RECIPIENT', None, -1),
    'IN2_12': ('leaf', None, 'ST', 'CHAMPUS_ORGANIZATION', None, -1),
    'IN2_13': ('leaf', None, 'ST', 'CHAMPUS_STATION', None, -1),
    'IN2_14': ('leaf', None, 'IS', 'CHAMPUS_SERVICE', 'HL70140', -1),
    'IN2_15': ('leaf', None, 'IS', 'CHAMPUS_RANK_GRADE', 'HL70141', -1),
    'IN2_16': ('leaf', None, 'IS', 'CHAMPUS_STATUS', 'HL70142', -1),
    'IN2_17': ('leaf', None, 'DT', 'CHAMPUS_RETIRE_DATE', None, -1),
    'IN2_18': ('leaf', None, 'ID', 'CHAMPUS_NON_AVAIL_CERT_ON_FILE', 'HL70136', -1),
    ...
    'IN2_24': ('leaf', None, 'ST', 'NON_COVERED_INSURANCE_CODE', 'HL70143', -1),
    ...
    'IN2_28': ('sequence', DATATYPES_STRUCTS['CM_RMC'], 'CM_RMC', 'ROOM_COVERAGE_TYPE_AMOUNT', None, -1),
    'IN2_29': ('sequence', DATATYPES_STRUCTS['CM_PTA'], 'CM_PTA', 'POLICY_TYPE_AMOUNT', None, -1),
    ...
    'IN2_33': ('leaf', None, 'IS', 'CITIZENSHIP', 'HL70171', -1),
    'IN2_34': ('sequence', DATATYPES_STRUCTS['CE'], 'CE', 'PRIMARY_LANGUAGE', 'HL70296', -1),
    'IN2_35': ('leaf', None, 'IS', 'LIVING_ARRANGEMENT', 'HL70220', -1),
    'IN2_36': ('sequence', DATATYPES_STRUCTS['CE'], 'CE', 'PUBLICITY_INDICATOR', 'HL70215', -1),
    'IN2_37': ('leaf', None, 'ID', 'PROTECTION_INDICATOR', 'HL70136', -1),
    'IN2_38': ('leaf', None, 'IS', 'STUDENT_INDICATOR', 'HL70231', -1),
    'IN2_39': ('leaf', None, 'IS', 'RELIGION', 'HL70006', -1),
    'IN2_40': ('sequence', DATATYPES_STRUCTS['XPN'], 'XPN', 'MOTHER_S_MAIDEN_NAME', None, -1),
    'IN2_41': ('sequence', DATATYPES_STRUCTS['CE'], 'CE', 'NATIONALITY_CODE', 'HL70212', -1),
    'IN2_42': ('leaf', None, 'IS', 'ETHNIC_GROUP', 'HL70189', -1),
    'IN2_43': ('leaf', None, 'IS', 'MARITAL_STATUS', 'HL70002', -1),
    'IN2_44': ('leaf', None, 'DT', 'EMPLOYMENT_START_DATE', None, -1),
    ...
    'IN2_53': ('sequence', DATATYPES_STRUCTS['XTN'], 'XTN', 'INSURED_S_CONTACT_PERSON_TELEPHONE_NUMBER', None, -1),
    ...
    'IN2_62': ('leaf', None, 'IS', 'GUARANTOR_S_RELATIONSHIP_TO_INSURED', 'HL70063', -1),
    'IN2_63': ('sequence', DATATYPES_STRUCTS['XTN'], 'XTN', 'INSURED_S_TELEPHONE_NUMBER_HOME', None, -1),
    'IN2_64': ('sequence', DATATYPES_STRUCTS['XTN'], 'XTN', 'INSURED_S_EMPLOYER_TELEPHONE_NUMBER', None, -1),
    'IN2_65': ('sequence', DATATYPES_STRUCTS['CE'], 'CE', 'MILITARY_HANDICAPPED_PROGRAM', None, -1),
    'IN2_66': ('leaf', None, 'ID', 'SUSPEND_FLAG', 'HL70136', -1),
    'IN2_67': ('leaf', None, 'ID', 'CO_PAY_LIMIT_FLAG', 'HL70136', -1),
    ...
    'IN2_71': ('leaf', None, 'IS', 'RACE', 'HL70005', -1),
    'IN2_72': ('leaf', None, 'ID', 'PATIENT_RELATIONSHIP_TO_INSURED', None, -1),
    ...
    'IN3_14': ('sequence', DATATYPES_STRUCTS['XCN'], 'XCN', 'PHYSICIAN_REVIEWER', None, -1),
    ...
    'IN3_20': ('sequence', DATATYPES_STRUCTS['CM_PCF'], 'CM_PCF', 'PRE_CERTIFICATION_REQUIRED_WINDOW', None, -1),
    ...
    'IN3_25': ('sequence', DATATYPES_STRUCTS['XCN'], 'XCN', 'SECOND_OPINION_PHYSICIAN', None, -1),
    'LCC_1': ('sequence', DATATYPES_STRUCTS['PL'], 'PL', 'PRIMARY_KEY_VALUE', None, -1),
    'LCC_2': ('leaf', None, 'IS', 'LOCATION_DEPARTMENT', 'HL70264', -1),
    'LCC_3': ('sequence', DATATYPES_STRUCTS['CE'], 'CE', 'ACCOMMODATION_TYPE', None, -1),
    'LCC_4': ('sequence', DATATYPES_STRUCTS['CE'], 'CE', 'CHARGE_CODE', None, -1),
    'LCH_1': ('sequence', DATATYPES_STRUCTS['PL'], 'PL', 'PRIMARY_KEY_VALUE', None, -1),
    ...
    'LDP_1': ('sequence', DATATYPES_STRUCTS['PL'], 'PL', 'LDP_PRIMARY_KEY_VALUE', None, -1),
    'LDP_2': ('leaf', None, 'IS', 'LOCATION_DEPARTMENT', 'HL70264', -1),
    'LDP_3': ('leaf', None, 'IS', 'LOCATION_SERVICE', 'HL70069', -1),
    'LDP_4': ('sequence', DATATYPES_STRUCTS['CE'], 'CE', 'SPECIALITY_TYPE', 'HL70265', -1),
    'LDP_5': ('leaf', None, 'ID', 'VALID_PATIENT_CLASSES', 'HL70004', -1),
    'LDP_6': ('leaf', None, 'ID', 'ACTIVE_INACTIVE_FLAG', 'HL70183', -1),
    'LDP_7': ('sequence', DATATYPES_STRUCTS['TS'], 'TS', 'ACTIVATION_DATE', None, -1),
    ...
    'LOC_1': ('sequence', DATATYPES_STRUCTS['PL'], 'PL', 'PRIMARY_KEY_VALUE', None, -1),
    'LOC_2': ('leaf', None, 'ST', 'LOCATION_DESCRIPTION', None, -1),
    'LOC_3': ('leaf', None, 'IS', 'LOCATION_TYPE', 'HL70260', -1),
    'LOC_4': ('sequence', DATATYPES_STRUCTS['XON'], 'XON', 'ORGANIZATION_NAME', None, -1),
    ...
    'LOC_8': ('leaf', None, 'ID', 'LOCATION_EQUIPMENT', 'HL70261', -1),
    'LRL_1': ('sequence', DATATYPES_STRUCTS['PL'], 'PL', 'PRIMARY_KEY_VALUE', None, -1),
    ...
    'MFI_2': ('sequence', DATATYPES_STRUCTS['HD'], 'HD', 'MASTER_FILE_APPLICATION_IDENTIFIER', 'HL70176', -1),
    ...
    'MRG_1': ('sequence', DATATYPES_STRUCTS['CX'], 'CX', 'PRIOR_PATIENT_ID_INTERNAL', None, -1),
    ...
    'MRG_4': ('sequence', DATATYPES_STRUCTS['CX'], 'CX', 'PRIOR_PATIENT_ID_EXTERNAL', None, -1),
    ...
    'MSH_3': ('sequence', DATATYPES_STRUCTS['HD'], 'HD', 'SENDING_APPLICATION', None, -1),
    'MSH_4': ('sequence', DATATYPES_STRUCTS['HD'], 'HD', 'SENDING_FACILITY', None, -1),
    'MSH_5': ('sequence', DATATYPES_STRUCTS['HD'], 'HD', 'RECEIVING_APPLICATION', None, -1),
    'MSH_6': ('sequence', DATATYPES_STRUCTS['HD'], 'HD', 'RECEIVING_FACILITY', None, -1),
    ...
    'NK1_11': ('sequence', DATATYPES_STRUCTS['JCC'], 'JCC', 'NEXT_OF_KIN_JOB_ASSOCIATED_PARTIES_CODE_CLASS', None, -1),
    'NK1_12': ('sequence', DATATYPES_STRUCTS['CX'], 'CX', 'NEXT_OF_KIN_ASSOCIATED_PARTIES_EMPLOYEE_NUMBER', None, -1),
    'NK1_13': ('sequence', DATATYPES_STRUCTS['XON'], 'XON', 'ORGANIZATION_NAME', None, -1),
    'NK1_14': ('leaf', None, 'IS', 'MARITAL_STATUS', 'HL70002', -1),
    'NK1_15': ('leaf', None, 'IS', 'SEX', 'HL70001', -1),
    'NK1_16': ('sequence', DATATYPES_STRUCTS['TS'], 'TS', 'DATE_OF_BIRTH', None, -1),
    'NK1_17': ('leaf', None, 'IS', 'LIVING_DEPENDENCY', 'HL70223', -1),
    'NK1_18': ('leaf', None, 'IS', 'AMBULATORY_STATUS', 'HL70009', -1),
    'NK1_19': ('leaf', None, 'IS', 'CITIZENSHIP', 'HL70171', -1),
    'NK1_20': ('sequence', DATATYPES_STRUCTS['CE'], 'CE', 'PRIMARY_LANGUAGE', 'HL70296', -1),
    'NK1_21': ('leaf', None, 'IS', 'LIVING_ARRANGEMENT', 'HL70220', -1),
    'NK1_22': ('sequence', DATATYPES_STRUCTS['CE'], 'CE', 'PUBLICITY_INDICATOR', 'HL70215', -1),
    'NK1_23': ('leaf', None, 'ID', 'PROTECTION_INDICATOR', 'HL70136', -1),
    'NK1_24': ('leaf', None, 'IS', 'STUDENT_INDICATOR', 'HL70231', -1),
    'NK1_25': ('leaf', None, 'IS', 'RELIGION', 'HL70006', -1),
    'NK1_26': ('sequence', DATATYPES_STRUCTS['XPN'], 'XPN', 'MOTHER_S_MAIDEN_NAME', None, -1),
    'NK1_27': ('sequence', DATATYPES_STRUCTS['CE'], 'CE', 'NATIONALITY_CODE', 'HL70212', -1),
    'NK1_28': ('leaf', None, 'IS', 'ETHNIC_GROUP', 'HL70189', -1),
    ...
    'NK1_33': ('sequence', DATATYPES_STRUCTS['CX'], 'CX', 'ASSOCIATED_PARTY_S_IDENTIFIERS', None, -1),
    'NK1_34': ('leaf', None, 'IS', 'JOB_STATUS', 'HL70311', -1),
    'NK1_35': ('leaf', None, 'IS', 'RACE', 'HL70005', -1),
    'NK1_36': ('leaf', None, 'IS', 'HANDICAP', 'HL70310', -1),
    'NK1_37': ('leaf', None, 'ST', 'CONTACT_PERSON_SOCIAL_SECURITY_NUMBER', None, -1),
    'NPU_1': ('sequence', DATATYPES_STRUCTS['PL'], 'PL', 'BED_LOCATION', 'HL70079', -1),
    ...
    'NSC_6': ('leaf', None, 'ST', 'NEW_CPU', 'HL70206', -1),
    'NSC_7': ('leaf', None, 'ST', 'NEW_FILESERVER', None, -1),
    'NSC_8': ('leaf', None, 'ST', 'NEW_APPLICATION', None, -1),
    'NST_1': ('leaf', None, 'ID', 'STATISTICS_AVAILABLE', 'HL70125', -1),
    ...
    'OBR_5': ('leaf', None, 'ID', 'PRIORITY', None, -1),
    ...
    'OBR_26': ('sequence', DATATYPES_STRUCTS['CM_PRL'], 'CM_PRL', 'PARENT_RESULT', None, -1),
    ...
    'OBX_11': ('leaf', None, 'ID', 'OBSERV_RESULT_STATUS', 'HL70085', -1),
    ...
    'OM1_6': ('sequence', DATATYPES_STRUCTS['CE'], 'CE', 'OBSERVATION_DESCRIPTION', None, -1),
    ...
    'OM1_13': ('sequence', DATATYPES_STRUCTS['CE'], 'CE', 'IDENTITY_OF_INSTRUMENT_USED_TO_PERFROM_THIS_STUDY', None, -1),
    ...
    'OM1_17': ('leaf', None, 'TN', 'TELEPHONE_NUMBER_OF_SECTION', None, -1),
    'OM1_18': ('leaf', None, 'ID', 'NATURE_OF_TEST_OBSERVATION', 'HL70174', -1),
    'OM1_19': ('sequence', DATATYPES_STRUCTS['CE'], 'CE', 'REPORT_SUBHEADER', None, -1),
    'OM1_20': ('leaf', None, 'ST', 'REPORT_DISPLAY_ORDER', None, -1),
    'OM1_21': ('sequence', DATATYPES_STRUCTS['TS'], 'TS', 'DATE_TIME_STAMP_FOR_ANY_CHANGE_IN_DEF_ATTRI_FOR_OBS', None, -1),
    'OM1_22': ('sequence', DATATYPES_STRUCTS['TS'], 'TS', 'EFFECTIVE_DATE_TIME_OF_CHANGE_IN_TEST_PROC_THAT_MAKE_RESULTS_NON_COMPARABLE', None, -1),
    ...
    'OM1_28': ('sequence', DATATYPES_STRUCTS['AD'], 'AD', 'ADDRESS_OF_OUTSIDE_SITE_S', None, -1),
    'OM1_29': ('leaf', None, 'TN', 'PHONE_NUMBER_OF_OUTSIDE_SITE', None, -1),
    'OM1_30': ('leaf', None, 'ID', 'CONFIDENTIALITY_CODE', 'HL70177', -1),
    'OM1_31': ('sequence', DATATYPES_STRUCTS['CE'], 'CE', 'OBSERVATIONS_REQUIRED_TO_INTERPRET_THE_OBSERVATION', None, -1),
    ...
    'OM1_35': ('leaf', None, 'ST', 'RULES_THAT_TRIGGER_REFLEX_TESTING', None, -1),
    ...
    'OM1_42': ('sequence', DATATYPES_STRUCTS['CE'], 'CE', 'KIND_OF_QUANTITY_OBSERVED', None, -1),
    'OM1_43': ('sequence', DATATYPES_STRUCTS['CE'], 'CE', 'POINT_VERSUS_INTERVAL', None, -1),
    'OM1_44': ('leaf', None, 'TX', 'CHALLENGE_INFORMATION', None, -1),
    'OM1_45': ('sequence', DATATYPES_STRUCTS['CE'], 'CE', 'RELATIONSHIP_MODIFIER', None, -1),
    'OM1_46': ('sequence', DATATYPES_STRUCTS['CE'], 'CE', 'TARGET_ANATOMIC_SITE_OF_TEST', None, -1),
    'OM1_47': ('sequence', DATATYPES_STRUCTS['CE'], 'CE', 'MODALITY_OF_IMAGING_MEASUREMENT', None, -1),
    ...
    'OM2_6': ('sequence', DATATYPES_STRUCTS['CM_RFR'], 'CM_RFR', 'REFERENCE_NORMAL_RANGE_ORDINAL_CONTINUOUS_OBS', None, -1),
    'OM2_7': ('sequence', DATATYPES_STRUCTS['CM_RANGE'], 'CM_RANGE', 'CRITICAL_RANGE_FOR_ORDINAL_CONTINUOUS_OBS', None, -1),
    'OM2_8': ('sequence', DATATYPES_STRUCTS['CM_ABS_RANGE'], 'CM_ABS_RANGE', 'ABSOLUTE_RANGE_FOR_ORDINAL_CONTINUOUS_OBS', None, -1),
    'OM2_9': ('sequence', DATATYPES_STRUCTS['CM_DLT'], 'CM_DLT', 'DELTA_CHECK_CRITERIA', None, -1),
    ...
    'OM5_2': ('sequence', DATATYPES_STRUCTS['CE'], 'CE', 'TEST_OBSERVATIONS_INCLUDED_W_AN_ORDERED_TEST_BATTERY', None, -1),
    ...
    'PCR_22': ('leaf', None, 'ID', 'EVENT_CAUSALITY_OBSERVATIONS', 'HL70232', -1),
    ...
    'PD1_6': ('leaf', None, 'IS', 'HANDICAP', 'HL70310', -1),
    ...
    'PD1_11': ('sequence', DATATYPES_STRUCTS['CE'], 'CE', 'PUBLICITY_INDICATOR', 'HL70215', -1),
    ...
    'PDC_11': ('leaf', None, 'ST', 'MARKETING_APPROVAL_IDENTIFIER', None, -1),
    ...
    'PDC_14': ('sequence', DATATYPES_STRUCTS['TS'], 'TS', 'DATE_FIRST_MARKED', None, -1),
    'PDC_15': ('sequence', DATATYPES_STRUCTS['TS'], 'TS', 'DATE_LAST_MARKED', None, -1),
    ...
    'PID_2': ('sequence', DATATYPES_STRUCTS['CX'], 'CX', 'PATIENT_ID_EXTERNAL_ID', None, -1),
    'PID_3': ('sequence', DATATYPES_STRUCTS['CX'], 'CX', 'PATIENT_ID_INTERNAL_ID', None, -1),
    'PID_4': ('sequence', DATATYPES_STRUCTS['CX'], 'CX', 'ALTERNATE_PATIENT_ID', None, -1),
    ...
    'PID_10': ('leaf', None, 'IS', 'RACE', 'HL70005', -1),
    'PID_11': ('sequence', DATATYPES_STRUCTS['XAD'], 'XAD', 'PATIENT_ADDRESS', None, -1),
    'PID_12': ('leaf', None, 'IS', 'COUNTY_CODE', None, -1),
    ...
    'PID_16': ('leaf', None, 'IS', 'MARITAL_STATUS', 'HL70002', -1),
    'PID_17': ('leaf', None, 'IS', 'RELIGION', 'HL70006', -1),
    'PID_18': ('sequence', DATATYPES_STRUCTS['CX'], 'CX', 'PATIENT_ACCOUNT_NUMBER', None, -1),
    'PID_19': ('leaf', None, 'ST', 'SSN_NUMBER_PATIENT', None, -1),
    'PID_20': ('sequence', DATATYPES_STRUCTS['DLN'], 'DLN', 'DRIVER_S_LICENSE_NUMBER', None, -1),
    'PID_21': ('sequence', DATATYPES_STRUCTS['CX'], 'CX', 'MOTHER_S_IDENTIFIER', None, -1),
    'PID_22': ('leaf', None, 'IS', 'ETHNIC_GROUP', 'HL70189', -1),
    ...
    'PID_26': ('leaf', None, 'IS', 'CITIZENSHIP', 'HL70171', -1),
    'PID_27': ('sequence', DATATYPES_STRUCTS['CE'], 'CE', 'VETERANS_MILITARY_STATUS', 'HL70172', -1),
    'PID_28': ('sequence', DATATYPES_STRUCTS['CE'], 'CE', 'NATIONALITY_CODE', 'HL70212', -1),
    ...
    'PR1_6': ('leaf', None, 'ID', 'PROCEDURE_TYPE', 'HL70230', -1),
    ...
    'PR1_15': ('sequence', DATATYPES_STRUCTS['CE'], 'CE', 'ASSOCIATED_DIAGNOSIS_CODE', None, -1),
    'PRA_1': ('leaf', None, 'ST', 'PRA_PRIMARY_KEY_VALUE', None, -1),
    'PRA_2': ('sequence', DATATYPES_STRUCTS['CE'], 'CE', 'PRACTIONER_GROUP', None, -1),
    'PRA_3': ('leaf', None, 'ID', 'PRACTIONER_CATEGORY', None, -1),
    'PRA_4': ('leaf', None, 'ID', 'PROVIDER_BILLING', 'HL70186', -1),
    'PRA_5': ('sequence', DATATYPES_STRUCTS['CM_SPD'], 'CM_SPD', 'SPECIALTY', 'HL70187', -1),
    ...
    'PRC_1': ('sequence', DATATYPES_STRUCTS['CE'], 'CE', 'PRIMARY_KEY_VALUE', 'HL70132', -1),
    'PRC_2': ('sequence', DATATYPES_STRUCTS['EI'], 'EI', 'FACILITY_ID', None, -1),
    'PRC_3': ('sequence', DATATYPES_STRUCTS['CE'], 'CE', 'DEPARTMENT', None, -1),
    'PRC_4': ('leaf', None, 'ID', 'VALID_PATIENT_CLASSES', 'HL70004', -1),
    ...
    'PRC_13': ('leaf', None, 'ID', 'PRICE_OVERRIDE_FLAG', 'HL70268', -1),
    ...
    'PRC_18': ('leaf', None, 'ID', 'CHARGE_ON_INDICATOR', 'HL70269', -1),
    'PRD_1': ('sequence', DATATYPES_STRUCTS['CE'], 'CE', 'ROLE', 'HL70286', -1),
    ...
    'PRD_7': ('sequence', DATATYPES_STRUCTS['CM_PI'], 'CM_PI', 'PROVIDER_IDENTIFIERS', None, -1),
    'PRD_8': ('sequence', DATATYPES_STRUCTS['TS'], 'TS', 'EFFECTIVE_START_DATE_OF_ROLE', None, -1),
    'PRD_9': ('sequence', DATATYPES_STRUCTS['TS'], 'TS', 'EFFECTIVE_END_DATE_OF_ROLE', None, -1),
    ...
    'PTH_5': ('sequence', DATATYPES_STRUCTS['CE'], 'CE', 'PATHWAY_LIFECYCLE_STATUS', None, -1),
    'PTH_6': ('sequence', DATATYPES_STRUCTS['TS'], 'TS', 'CHANGE_PATHWAY_LIFECYCLE_STATUS_DATE_TIME', None, -1),
    ...
    'PV1_50': ('sequence', DATATYPES_STRUCTS['CX'], 'CX', 'ALTERNATE_VISIT_ID', 'HL70192', -1),
    ...
    'PV2_8': ('sequence', DATATYPES_STRUCTS['TS'], 'TS', 'EXPECTED_ADMIT_DATE', None, -1),
    'PV2_9': ('sequence', DATATYPES_STRUCTS['TS'], 'TS', 'EXPECTED_DISCHARGE_DATE', None, -1),
    ...
    'PV2_30': ('leaf', None, 'IS', 'PATIENT_CHARGE_ADJUSTMENT_CODE', 'HL70218', -1),
    ...
    'PV2_35': ('leaf', None, 'ID', 'MILITARY_NON_AVAILABILTIY_CODE', 'HL70136', -1),
    ...
    'ROL_3': ('sequence', DATATYPES_STRUCTS['CE'], 'CE', 'ROLE', None, -1),
    ...
    'ROL_8': ('sequence', DATATYPES_STRUCTS['CE'], 'CE', 'ROLE_ACTION_ASSUMPTION_REASON', None, -1),
    'RQ1_1': ('leaf', None, 'ST', 'ANTICIPATED_PRICE', None, -1),
    'RQ1_2': ('sequence', DATATYPES_STRUCTS['CE'], 'CE', 'MANUFACTURED_ID', None, -1),
    ...
    'RXA_1': ('leaf', None, 'ID', 'GIVE_SUB_ID_COUNTER', None, -1),
    ...
    'RXD_9': ('sequence', DATATYPES_STRUCTS['CE'], 'CE', 'DISPENSE_NOTES', None, -1),
    ...
    'RXD_13': ('sequence', DATATYPES_STRUCTS['CM_LA1'], 'CM_LA1', 'DISPENSE_TO_LOCATION', None, -1),
    ...
    'RXE_14': ('sequence', DATATYPES_STRUCTS['CN'], 'CN', 'PHARMACIST_TREATMENT_SUPPLIER_S_VERIFIER_ID', None, -1),
    ...
    'RXE_18': ('sequence', DATATYPES_STRUCTS['TS'], 'TS', 'DATE_TIME_OF_MOST_RECENT_REFILL_OR_DOSE_DISPENSED', None, -1),
    ...
    'RXG_1': ('leaf', None, 'ID', 'GIVE_SUB_ID_COUNTER', None, -1),
    ...
    'RXG_11': ('sequence', DATATYPES_STRUCTS['CM_LA1'], 'CM_LA1', 'DISPENSE_TO_LOCATION', None, -1),
    ...
    'RXO_15': ('sequence', DATATYPES_STRUCTS['CN'], 'CN', 'PHARMACIST_TREATMENT_SUPPLIER_S_VERIFIER_ID', None, -1),
    ...
    'STF_17': ('leaf', None, 'IS', 'MARITAL_STATUS', 'HL70002', -1),
    ...
    'STF_22': ('sequence', DATATYPES_STRUCTS['DLN'], 'DLN', 'DRIVER_S_LICENSE_NUMBER', None, -1),
    ...
    'UB1_10': ('sequence', DATATYPES_STRUCTS['CM_UVC'], 'CM_UVC', 'VALUE_AMOUNT_CODE_46_49', 'HL70153', -1),
    'UB1_11': ('leaf', None, 'NM', 'NUMBER_OF_GRACE_DAYS_90', None, -1),
    'UB1_12': ('sequence', DATATYPES_STRUCTS['CE'], 'CE', 'SPEC_PROGRAM_INDICATOR_44', None, -1),
    ...
    'UB2_6': ('sequence', DATATYPES_STRUCTS['CM_UVC'], 'CM_UVC', 'VALUE_AMOUNT_CODE', None, -1),
    'UB2_7': ('sequence', DATATYPES_STRUCTS['CM_OCD'], 'CM_OCD', 'OCCURRENCE_CODE_DATE_32_35', None, -1),
